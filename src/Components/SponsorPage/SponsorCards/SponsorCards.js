...
export default function AltCard() {
  ...
  const testClick = (elem) => {
    console.log(kidsData.details.indexOf(elem));
  };
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        {kidsData.details.map((elem) => (
          <Grid item xs={4} key={kidsData.details.indexOf(elem)}>
            <Card>
              <CardMedia
                component="img"
                height="250"
              ...
              <CardContent>
                ...
                >
                  ...
                  <br></br>
                  <span>
                    <b>Waiting For Sponsorship</b> : {elem.WaitForSponsor} days
                  </span>
                  <br></br>
                  <span>
                  ...
                  <br></br>
                  <span>
                    <b>Family Income</b> : {elem.FamilyIncome} €
                  </span>
                </Typography>
              </CardContent>
              <Button
